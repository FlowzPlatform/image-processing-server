...
extern WandExport char
  ...
  *MagickGetDominantColor(MagickWand *);
...
extern WandExport MagickBooleanType
  ...
  MagickCylinderize(MagickWand *, const char *, double , double , double , double , double , double, double ),
...
extern WandExport MagickWand
  ...
  *MagickBevelImage(MagickWand *, char *, double , double ,double , double , double , char *, char *, char *, char *, char *),
  *MagickTshirtImage(MagickWand *, MagickWand *, char * , char * , char * , char * , int , char * , int , int , int , int , int , int , char *);
