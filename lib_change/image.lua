...
do
  ...
  local _base_0 = {
    ...
    colorize = function(self, r, g, b)
      ...
      local pixel = ffi.gc(lib.NewPixelWand(), lib.DestroyPixelWand)
      lib.PixelSetRed(pixel, 255)
      lib.PixelSetGreen(pixel, 255)
      lib.PixelSetBlue(pixel, 255)

      local pixel2 = ffi.gc(lib.NewPixelWand(), lib.DestroyPixelWand)
      lib.PixelSetRed(pixel2, r)
      lib.PixelSetGreen(pixel2, g)
      lib.PixelSetBlue(pixel2, b)
