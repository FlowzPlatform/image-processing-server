...
engrave, four_colour, dcolor, foil, geldom, toneontone, background = ngx.var.arg_sig, ngx.var.arg_size, ngx.var.path, ngx.var.ext,
...
(ngx.var.arg_back and ngx.var.arg_back or "")
...
local font_size, text_width, text_height, text_composex, text_composey, text_color, text_flip, text_flop, text_rotate, font_family, text_curve = (ngx.var.arg_font_size and ngx.var.arg_font_size or ""), 
...
local artwork_height, artwork_width = ngx.var.arg_a_height, ngx.var.arg_a_width
...
.. font_family .. texts .. text_curve .. background)
...
local imgSrc = magick.load_image("html/product-images/54607c1317207c5f03d63af1/12323rdfcabc234/main/"..path)
